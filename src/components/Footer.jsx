  ...
  return (
    <footer className="w-full">
      <div className="bg-gray-100 py-6">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 text-gray-700">
          {/* Popular Locations */}
          <div>
          ...
          <div className="">
            ...
            <a href="#" className="text-xs hover:underline">Tech@OLX</a>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-xs">
              ...
              <li><a href="#" className="hover:underline">Vulnerability Disclosure</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-3 text-xl fill-teal-800">
                <svg className="w-5 h-5" viewBox="0 0 1024 1024" data-aut-id="icon" fillRule="evenodd">
            ...
            <div className="mt-3">
              <img src="https://statics.olx.in/external/base/img/playstore.webp" alt="Google Play" className="w-32 mb-2"/>
              <img src="https://statics.olx.in/external/base/img/appstore.webp" alt="App Store" className="w-32"/>
            </div>
          </div>
        </div>
      </div>

      <div className="bg-[#012A2F] py-6">
        <div className="max-w-6xl mx-auto px-4 flex flex-col gap-10 justify-between items-center text-white text-sm">
          <div className="flex flex-wrap w-full items-center justify-around space-x-6 mb-4 md:mb-0">
            <span className="text-lg font-semibold">CarTrade<span className="bg-white text-black px-1 rounded">Tech</span> GROUP</span>
            <span> | </span>
            <img src="https://statics.olx.in/external/base/img/cartrade/logo/olx.svg?v=1" alt="OLX" className="h-15"/>
            <img src="https://statics.olx.in/external/base/img/cartrade/logo/carwale.svg?v=1" alt="CarWale" className="h-15"/>
            <img src="https://statics.olx.in/external/base/img/cartrade/logo/bikewale.svg?v=1" alt="BikeWale" className="h-15"/>
            <img src="https://statics.olx.in/external/base/img/cartrade/logo/cartrade.svg?v=1" alt="CarTrade" className="h-15"/>
            <img src="https://statics.olx.in/external/base/img/cartrade/logo/mobility.svg?v=1" alt="Mobility Outlook" className="h-15"/>
          </div>

          <div className="text-gray-300 flex flex-row justify-between w-full px-6">
            <span>
            <a href="#" className="hover:underline">Help</a> - 
            <a href="#" className="hover:underline">Sitemap</a>
            </span>
            <p className="mt-1">All rights reserved © 2006-2025 OLX</p>
          </div>
        </div>
      </div>
    </footer>
